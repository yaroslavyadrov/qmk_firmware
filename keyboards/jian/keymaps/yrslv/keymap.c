...
[1] = LAYOUT(
  KC_TRNS, KC_CAPS, KC_PSLS, KC_7, KC_8, KC_9,  KC_MINS,        KC_AMPR,   KC_COLN,   KC_PMNS,   KC_GT,   KC_NO,   KC_NO,  RSG(KC_4),
           ...
           KC_LCMD, KC_0,    KC_1, KC_2, KC_3,  KC_PDOT,        KC_PIPE,   KC_UNDS,   KC_LCBR,   KC_RCBR, KC_RALT,   KC_RCTL,
                        LT(3,KC_ENT), KC_TRNS,  KC_TRNS,        KC_TRNS,   LT(3, KC_SPC),   KC_TRNS
),
[2] = LAYOUT(
  KC_TRNS, KC_CAPS,  KC_NO,   KC_F7,   KC_F8,   KC_F9,   KC_F10,        KC_KB_VOLUME_UP,   KC_ENT,        RALT(KC_ENT), LAG(KC_L), KC_RSFT, KC_PGUP,  RSG(KC_4),
